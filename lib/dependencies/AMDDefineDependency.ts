...
AMDDefineDependency.Template.prototype.apply = function (dep, source) {
	...
	const branch = (localModuleVar ? 'l' : '') + (dep.arrayRange ? 'a' : '') + (dep.objectRange
			? 'o'
			: '') + (dep.functionRange ? 'f' : '');
	const defs = {
		f: [
			'var __WEBPACK_AMD_DEFINE_RESULT__;',
			'!(__WEBPACK_AMD_DEFINE_RESULT__ = #.call(exports, __webpack_require__, exports, module), ' + '__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__))'
		],
		o: ['', '!(module.exports = #)'],
		of: [
			'var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;',
			'!(__WEBPACK_AMD_DEFINE_FACTORY__ = (#), ' + '__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === \'function\' ? ' + '(__WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module)) : ' + '__WEBPACK_AMD_DEFINE_FACTORY__), ' + '__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__))'
		],
		af: [
			'var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;',
			'!(__WEBPACK_AMD_DEFINE_ARRAY__ = #, __WEBPACK_AMD_DEFINE_RESULT__ = #.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), ' + '__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__))'
		],
		ao: ['', '!(#, module.exports = #)'],
		aof: [
		...
		lof: [
			...
			'!(__WEBPACK_AMD_DEFINE_FACTORY__ = (#), XXX = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === \'function\' ? ' + '(__WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module)) : __WEBPACK_AMD_DEFINE_FACTORY__))'
		],
		laf: [
		...
		laof: [
			...
			'!(__WEBPACK_AMD_DEFINE_ARRAY__ = #, __WEBPACK_AMD_DEFINE_FACTORY__ = (#), ' + 'XXX = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === \'function\' ? ' + '(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__))'
		]
	};
	replace(...defs[branch]);
};
